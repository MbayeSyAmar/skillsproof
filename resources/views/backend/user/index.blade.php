        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('user.index')}}">Tous les utilisateurs</a></li>
                </ol>
            </div>
        </div>
                    ...
                    <div id="list-view" class="tab-pane fade active show col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{route('user.create')}}" class="btn btn-primary">+ Ajouter un nouveau</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            @empty
                                            <tr>
                                                <th colspan="7" class="text-center">Utilisateurs non trouvé</th>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            ...
                                            <ul class="list-group mb-3 list-group-flush">
                                                ...
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    <span class="mb-0">Tous les Acces :</span>
                                                    <span class="badge {{$d->full_access==1?"
                                                        badge-info":"badge-warning"}}">@if($d->full_access==1){{__('Yes')}}
                                                        @else{{__('No')}} @endif</span>
                                                </li>
                                            ...
                                            <a class="btn btn-outline-primary btn-rounded mt-3 px-4"
                                                href="about-student.html">lire plus</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card card-profile">
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            <p class="mt-3 px-4">Utilisateur non trouvé</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
