        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('user.create')}}">Ajouter un utilisateur</a></li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <form action="{{route('user.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Deuxieme nom</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="roleId">
                                            ...
                                            <option value="{{$r->id}}" {{old('roleId')==$r->id?'selected':''}}>
                                                {{$r->name}}</option>
                                            @empty
                                            <option value="">Role non trouvé</option>
                                            @endforelse
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Tous les Acces</label>
                                        <select class="form-control" name="fullAccess">
                                            <option value="0" @if(old('fullAccess')==0) selected @endif>Non</option>
                                            <option value="1" @if(old('fullAccess')==1) selected @endif>Oui</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
