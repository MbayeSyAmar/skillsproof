        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('role.index')}}">toutes les Permissions</a></li>
                </ol>
            </div>
        </div> 
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav nav-pills mb-3">
                    ...
                    <li class="nav-item"><a href="javascript:void()" data-toggle="tab" class="nav-link btn-primary">Vu en grille</a></li>
                </ul>
            </div>
            <div class="col-lg-12">
