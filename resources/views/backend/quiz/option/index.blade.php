                    ...
                    <div id="list-view" class="tab-pane fade active show col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Liste de toutes les options </h4>
                                <a href="{{route('option.create')}}" class="btn btn-primary">+ Ajouter un nouveau</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            @empty
                                            <tr>
                                                <th colspan="4" class="text-center">Option non trouvée</th>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
