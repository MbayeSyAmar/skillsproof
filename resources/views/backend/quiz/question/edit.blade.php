        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Modifier les questions</a></li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <form action="{{route('question.update',encryptor('encrypt', $question->id))}}" method="post"
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="quizId">
                                            ...
                                            <option value="{{$q->id}}" {{old('quizId', $question->quiz_id) ==
                                                ...
                                                {{$q->title}}</option>
                                            @empty
                                            <option value="">Quiz non trouvé</option>
                                            @endforelse
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label"> Type Qestion</label>
                                        <select class="form-control" name="questionType">
                                            ...
                                            <option value="short_answer" @if(old('questionType', $question->type)
                                                =='short_answer' )
                                                selected @endif>Reponse courte</option>
                                        </select>
                                    </div>
