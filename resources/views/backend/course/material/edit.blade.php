        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Modifier le matériel de cours</h4>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Accueil</a></li>
                    <li class="breadcrumb-item active"><a href="{{route('material.index')}}">Matériels de cours</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Modifier le matériel de cours</a></li>
                </ol>
            </div>
        </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="materialType">
                                            <option value="video" @if(old('materialType', $material->type)=='video' ) selected @endif>Vidéo</option>
                                            <option value="document" @if(old('materialType', $material->type)=='document' ) selected @endif>Document</option>
                                            <option value="quiz" @if(old('materialType', $material->type)=='quiz' ) selected @endif>Quiz</option>
                                        </select>
                                    </div>
