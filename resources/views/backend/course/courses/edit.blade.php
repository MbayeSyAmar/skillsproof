        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Modifier le Cours</a></li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('course.updateforAdmin',encryptor('encrypt', $course->id))}}" method="post"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status">
                                            <option value="0" @if(old('status',$course->status)==0) selected @endif>En attente</option>
                                            <option value="1" @if(old('status',$course->status)==1) selected @endif>Inactif</option>
                                            <option value="2" @if(old('status',$course->status)==2) selected @endif>Actif</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="categoryId">
                                            ...
                                            <option value="{{$c->id}}" {{old('categoryId', $course->course_category_id) == $c->id?'selected':''}}>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="instructorId">
                                            ...
                                            <option value="{{$i->id}}" {{old('instructorId', $course->instructor_id) == $i->id?'selected':''}}>
                                                {{$i->name_en}}</option>
                                            @empty
                                            <option value="">Aucun instructeur trouvé</option>
                                            @endforelse
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="courseType">
                                            <option value="free" @if(old('courseType', $course->type)=='free' ) selected @endif>Gratuit</option>
                                            <option value="paid" @if(old('courseType', $course->type)=='paid' ) selected @endif>Payant</option>
                                            <option value="subscription" @if(old('courseType', $course->type)=='subscription' ) selected @endif>Abonnement</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="courseDifficulty">
                                            <option value="beginner" @if(old('courseDifficulty', $course->difficulty)=='beginner' ) selected @endif>Débutant</option>
                                            <option value="intermediate" @if(old('courseDifficulty', $course->difficulty)=='intermediate' ) selected @endif>Intermédiaire</option>
                                            <option value="advanced" @if(old('courseDifficulty', $course->difficulty)=='advanced' ) selected @endif>Avancé</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <span class="text-danger"> {{ $errors->first('subscription_price', $course->subscription_price) }}</span>
                                    @endif
                                </div>
                            
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Commence le</label>
                                        <input type="date" class="form-control" name="start_from"
                                            value="{{old('start_from')}}">
                                    </div>
                                    @if($errors->has('start_from'))
                                    <span class="text-danger"> {{ $errors->first('start_from', $course->start_from) }}</span>
                                    @endif
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Nombre de leçons</label>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="requirement_en">{{old('requirement_en',$course->requirement_en)}}</textarea>
                                    </div>
                                    @if($errors->has('requirement_en'))
                                    <span class="text-danger"> {{ $errors->first('requirement_en') }}</span>
                                    @endif
                                </div>
                            
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Prérequis en anglais</label>
                                        <textarea class="form-control" name="requirement_bn">{{old('requirement_bn',$course->requirement_bn)}}</textarea>
                                    </div>
                                    @if($errors->has('requirement_bn'))
                                    <span class="text-danger"> {{ $errors->first('requirement_bn') }}</span>
                                    @endif
                                </div>
                            </div>
                        ...
                        <form action="{{route('course.update',encryptor('encrypt', $course->id))}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="courseType">
                                            ...
                                            <option value="subscription" @if(old('courseType', $course->type)
                                                =='subscription' )
                                                selected @endif>Basé sur abonnement</option>
                                        </select>
                                    </div>
                                    @if($errors->has('courseType'))
                                    <span class="text-danger"> {{ $errors->first('courseType') }}</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="courseDifficulty">
                                            <option value="beginner" @if(old('courseDifficulty', $course->
                                                difficulty)=='beginner' ) selected @endif>Débutant
                                            </option>
                                            <option value="intermediate" @if(old('courseDifficulty', $course->
                                                difficulty)=='intermediate' ) selected @endif>Intermédiaire
                                            </option>
                                            <option value="advanced" @if(old('courseDifficulty', $course->
                                                difficulty)=='advanced' )
                                                selected @endif>Avancé</option>
                                        </select>
                                    </div>
                                    @if($errors->has('courseDifficulty'))
                                    <span class="text-danger"> {{ $errors->first('courseDifficulty') }}</span>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Début à partir de</label>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">প্রয়োজনীয়তা (বাংলায়)</label>
                                        <textarea class="form-control"
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Image d'affichage</label>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <button class="btn btn-primary" type="submit">Mettre à jour le cours</button>
                                </div>
                            </div>
                        </form>
