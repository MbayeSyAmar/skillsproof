            ...
            <div class="col-lg-12">
                <div class="row tab-content">
                    <div class="card-header">
                        <a href="{{route('course.create')}}" class="btn btn-primary">+ Ajouter nouveau</a>
                    </div>
                    <div class="col-lg-12">
                        <div class="row">
                            @forelse ($course as $d)
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right border py-0">
                                                <div class="py-2">
                                                    <a class="dropdown-item"
                                                        href="{{route('course.edit', encryptor('encrypt',$d->id))}}">Modifier</a>
                                                    <a class="dropdown-item text-danger" href="javascript:void(0);"
                                                        onclick="$('#form{{$d->id}}').submit()">Supprimer</a>
                                                    <form id="form{{$d->id}}"
                                        ...
                                        <div class="text-center">
                                            ...
                                            <ul class="list-group mb-3 list-group-flush">
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    ...
                                                    <strong>{{ $d->difficulty == 'beginner' ? __('Débutant') :
                                                        ($d->difficulty == 'intermediate' ? __('Intermédiaire') :
                                                        __('Avancé')) }}</strong>
                                                </li>
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    <span class="mb-0">Instructeur :</span>
                                                    <strong>{{$d->instructor?->name_en}}</strong>
                                                </li>
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    <span class="mb-0">Catégorie :</span>
                                                    <strong>{{$d->courseCategory?->category_name}}</strong>
                                                </li>
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    <span class="mb-0">Prix :</span>
                                            ...
                                            <a class="btn btn-outline-primary btn-rounded mt-3 px-4"
                                                href="about-student.html">En savoir plus</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card card-profile">
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            <p class="mt-3 px-4">Cours non trouvé</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
