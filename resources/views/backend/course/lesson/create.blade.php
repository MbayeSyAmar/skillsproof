...
@section('title', 'Ajouter une Leçon de Cours')
        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Ajouter une Leçon de Cours</h4>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('lesson.create')}}">Ajouter une Leçon de Cours</a>
                    </li>
                </ol>
            </div>
        </div>
