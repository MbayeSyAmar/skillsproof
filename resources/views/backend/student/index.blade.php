        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('student.index')}}">Etudiants</a></li>
                    <li class="breadcrumb-item active"><a href="{{route('student.index')}}">Tous les etudiants</a></li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <ul class="nav nav-pills mb-3">
                    <li class="nav-item"><a href="#list-view" data-toggle="tab"
                            class="nav-link btn-primary mr-1 show active">Vu en liste</a></li>
                    <li class="nav-item"><a href="#grid-view" data-toggle="tab" class="nav-link btn-primary">Vu en grille</a></li>
                </ul>
            </div>
            <div class="col-lg-12">
                    ...
                    <div id="list-view" class="tab-pane fade active show col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Liste de tous les etudiants </h4>
                                <a href="{{route('student.create')}}" class="btn btn-primary">+ Ajouter un nouveau</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            @empty
                                            <tr>
                                                <th colspan="7" class="text-center">Etudiant non trouvé</th>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
                        ...
                        <div class="row">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right border py-0">
                                                <div class="py-2">
                                                    <a class="dropdown-item"
                                                        href="{{route('student.edit', encryptor('encrypt',$d->id))}}">Modifier</a>
                                    ...
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            ...
                                            <a class="btn btn-outline-primary btn-rounded mt-3 px-4"
                                                href="about-student.html">lire de plus</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card card-profile">
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            <p class="mt-3 px-4">Etudiant non trouvé</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
