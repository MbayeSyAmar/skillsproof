        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('enrollment.index')}}">Tous les Enrollments</a></li>
                </ol>
            </div>
        </div>
                    ...
                    <div id="list-view" class="tab-pane fade active show col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Liste de tous les enrollments</h4>
                                <a href="{{route('enrollment.create')}}" class="btn btn-primary">+ Ajouter un nouveau</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        <thead>
                                            <tr>
                                                <th>{{__('#')}}</th>
                                                <th>{{__('Nom de l\eleve')}}</th>
                                                <th>{{__('Nom du cours')}}</th>
                                                <th>{{__('Image Course')}}</th>
                                                <th>{{__('Prix du cours')}}</th>
                                                <th>{{__('Date')}}</th>
                                                <th>{{__('Action')}}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            @empty
                                            <tr>
                                                <th colspan="6" class="text-center">Pas d'enrollment</th>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
