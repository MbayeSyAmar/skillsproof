        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('instructor.create')}}">Ajouter un instructeur</a></li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <form action="{{route('instructor.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Deuxième Numéro</label>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status">
                                            <option value="1" @if(old('status')==1) selected @endif>Actif</option>
                                            <option value="0" @if(old('status')==0) selected @endif>Inactif</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
