        ...
        <div class="container">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center bg-transparent mb-0">
                    ...
                    <li class="breadcrumb-item fs-6 text-secondary" aria-current="page">Mon profile</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <div class="students-info-intro-end">
                            ...
                            <div class="completed-courses">
                                ...
                                <div class="completed-courses-text">
                                    ...
                                    <p class="fs-6 mt-1">Cours terminés</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <nav class="students-info-intro__nav">
                    <div class="nav" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-profile-tab" data-bs-toggle="tab"
                            ...
                            aria-selected="true">Tableau de bord</button>
                        ...
                        <button class="nav-link" id="nav-coursesall-tab" data-bs-toggle="tab"
                            ...
                            aria-selected="false">Tous les cours</button>
                        ...
                        <button class="nav-link" id="nav-purchase-tab" data-bs-toggle="tab" data-bs-target="#nav-purchase"
                            type="button" role="tab" aria-controls="nav-purchase" aria-selected="false">Historique
                            des achats</button>

                        <button class="nav-link "><a href="{{ route('student_profile') }}"
                                class="text-secondary">Profil</a></button>

                        <button class="nav-link "><a href="{{ route('home') }}"
                                class="text-secondary">Accueil</a></button>
                    </div>
                </nav>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-6 col-12 mx-auto text-center">
                                            <h5 class="font-title--sm">Investissez dans votre carrière avec nous</h5>
                                            <p class="my-4 font-para--lg">
                                                Duis posuere maximus arcu eu tincidunt. Nam rutrum, nibh vitae tempus
                                                venenatis, ex tortor ultricies magna, et faucibus magna eros quis arcu.
                                            </p>
                                            <a href="{{ route('searchCourse') }}"
                                                class="button button-md button--primary">Allons-y</a>
                                        </div>
                                    </div>
                                </div>
                            </section>
                                ...
                                <div class="col-lg-4 col-md-6 col-md-6 mb-4">
                                    <div class="contentCard contentCard--watch-course">
                                        <div class="contentCard-top">
                                            <a href="#"><img
                                                    src="{{ asset('uploads/courses/' . $a->course?->image) }}"
                                        ...
                                        <div class="contentCard-bottom">
                                            ...
                                            <a class="button button-md button--primary-outline w-100 my-3"
                                                href="{{ route('watchCourse', encryptor('encrypt', $a->course?->id)) }}">Cours
                                                suivis</a>
                            ...
                            @empty
                                <div class="col-12 py-5">
                                    <div class="col-md-6 col-12 mx-auto text-center">
                                        ...
                                        <a href="{{ route('searchCourse') }}"
                                            class="button button-md button--primary">Enroll
                                            Now!</a>
                                    </div>
                                </div>
                            @endforelse
