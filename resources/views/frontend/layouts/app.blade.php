        ...
        <nav class="navbar navbar-expand-xl navbar-light bg-transparent">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{route('home')}}">
                    <img src="{{asset('frontend/dist/images/logo/logo1.png')}}" alt="Logo" class="img-fluid" />
                </a>
                    ...
                    <div class="d-flex align-items-center justify-content-between rightContent">
                        <form class="header__Search-form" id="searchForm">
                            ...
                            <div id="myOverlay" class="overlay">
                                <span class="closebtn" onclick="closeSearch()" title="Fermer l'Overlay">×</span>
                        ...
                        <a href="{{route('cart')}}" class="cart-nav border-0 bg-transparent mx-3">
                            ...
                            <span class="visually-hidden">Articles ajoutés</span>
                        </a>
                        ...
                        <div class="dropdown user-image ms-3" id="imageDropdown">
                            <a href="{{route('studentdashboard')}}" onclick="toggleDropdown(event)">
                                <img src="{{asset('uploads/students/'.request()->session()->get('image'))}}" alt="Profil Étudiant" height="48" width="48"/>
                            </a>
                            <div class="dropdown-content">
                                <a href="{{route('student_profile')}}">Profil</a>
                                <a href="{{route('studentdashboard')}}">Tableau de Bord</a>
                                <a href="{{route('studentlogOut')}}" class="text-danger">Déconnexion</a>
                            </div>
                        </div>
                        @else
                        <a href="{{route('studentLogin')}}" class="button button--text">Se connecter</a>
                        <a href="{{route('studentRegister')}}" class="button button--dark">S'inscrire</a>
                        @endif
                    </div>
                </div>
                ...
                <div class="navbar-mobile">
                    <div>
                        <div class="navbar-mobile__top">
                            <a href="index.html">
                                <img src="{{asset('frontend/dist/images/logo/logo1.png')}}" alt="brand"
                                    class="img-fluid" />
                            </a>
                            <div>
                                <a href="{{ route('cart') }}" class="cart-nav">
                                    ...
                                    <span class="badge bg-primary">{{ count((array) session('cart')) }}</span>
                                    <span class="visually-hidden">Ajouté</span>
                                </a>
                            ...
                            <ul class="navbar-mobile__menu-list">
                                ...
                                <li class="navbar-mobile__menu-item">
                                    ...
                                    <ul class="navbar-mobile__menu-dropmenu">
                                        ...
                                        <li><a href="{{route('student_profile')}}">Profil Etuidiant</a></li>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="footer__wrapper">
                        <div class="footer__wrapper_logo">
                            <img src="{{asset('frontend/dist/images/logo/footerlogo1.png')}}" alt="logo"
                                class="img-fluid" />
                        </div>
                        <p>
                            Bienvenue chez vous !
                ...
                <div class="col-lg-2 col-sm-4 col-6">
                    <div class="footer__list">
                        ...
                        <ul>
                            ...
                            <li><a href="course-search.html">Cours</a></li>
                ...
                <div class="col-lg-2 col-sm-4 col-6">
                    <div class="footer__list">
                        <h6>Liens Rapides</h6>
                        <ul>
                            <li><a href="event-search.html">Événements</a></li>
                            <li><a href="become-instructor.html">Devenir Instructeur</a></li>
                            <li><a href="#">Partenariats</a></li>
                            <li><a href="#">Obtenez l'application</a></li>
                        </ul>
                    </div>
                </div>
