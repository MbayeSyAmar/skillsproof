    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="cart-wizard-area">
                    <div class="image">
                        <img src="{{asset('uploads/courses/' . $details['image'])}}" alt="image du cours" />
                    </div>
                    <div class="text">
                        ...
                        <div class="bottom-wizard d-flex justify-content-between align-items-center">
                            <p>
                                {{$details['price'] ? '€' . $details['price'] : 'Gratuit'}}
            ...
            <div class="col-lg-4">
                ...
                <div class="summery-wizard">
                    ...
                    <div class="summery-wizard-text">
                        <h6>Remise Coupon ({{session('cart_details')['discount'] ?? 0.00}}%)</h6>
                    ...
                    <form action="{{route('coupon_check')}}" method="post">
                        ...
                        <a href="{{route('checkout')}}"
                            class="button button-lg button--primary form-control mb-lg-3">Commander</a>
                        <label for="coupon">Appliquer le Coupon</label>
                        <div class="cart-input">
                            <input type="text" name="coupon" class="form-control" placeholder="Code du Coupon" id="coupon" />
                            <button type="submit" class="sm-button">Appliquer</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <section class="section cart-area pb-0">
            <div class="container text-center">
                ...
                <h5>Aucun Cours dans Votre Panier Pour l’Instant</h5>
            </div>
        </section>
        @endif
    </div>
    ...
    $(".remove-from-cart").click(function(e) {
            ...
            if (confirm("Êtes-vous sûr de vouloir supprimer ?")) {
                $.ajax({
                    ...
                    data: {
                        _token: '{{csrf_token()}}',
                        id: ele.data('id') // Utiliser l'attribut data-id
                    },
