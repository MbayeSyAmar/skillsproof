        ...
        <div class="row">
            <div class="col-lg-7 mb-lg-0 order-2 order-lg-0 d-flex align-items-center">
                <div class="banner-two-start">
                    <h1 class="font-title--lg">Débloquez la connaissance n'importe où, n'importe quand avec des experts.</h1>
                    <p>
                        Notre engagement est de vous guider vers les meilleurs cours en ligne, en offrant des conseils d'experts, où que vous soyez, à tout moment.
                    </p>
                    <form>
                        <div class="banner-input">
                            <div class="main-input">
                                <input type="text" placeholder="qu'est-ce que vous voulez apprendre aujourd'hui..." />
                            ...
                            <div class="search-button">
                                <button class="button button-lg button--primary">Rechercher</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<!-- Parcourir les Catégories Commence Ici -->
<section class="section browse-categories">
    <div class="container">
        <h2 class="font-title--md text-center mb-0">Parcourir les Cours par Catégories Principales</h2>
            ...
            <div class="categories--box">
                ...
                <div class="browse-categories-item default-item-one mb-2">
                    ...
                    <div class="browse-categories-item-text">
                        <h6 class="font-title--card"><a href="frontend.courseDetails">{{$cat->category_name}}</a></h6>
    ...
    <div class="browse-categories-shape">
        <img src="{{asset('frontend/dist/images/shape/dots/dots-img-11.png')}}" alt="forme"
            class="img-fluid shape-01" />
        <img src="{{asset('frontend/dist/images/shape/line01.png')}}" alt="forme" class="img-fluid shape-02" />
    </div>
</section>
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="contentCard contentCard--course">
                                <h3>Pas de cours disponibles</h3>
                            </div>
                        </div>
                        @endforelse
                    </div>
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-more">
                                        ...
                                        <div class="book d-flex align-items-center">
                                            ...
                                            <span>{{$bc->lesson?$bc->lesson:0}} Leçon</span>
                                        </div>
                                        <div class="clock d-flex align-items-center">
                                            <div class="icon">
                                                <img src="{{asset('frontend/dist/images/icon/Clock.png')}}" alt="clock" />
...
<section class="section feature section section--bg-offwhite-one">
    <div class="container">
        <h2 class="font-title--md text-center">Pourquoi Vous Apprendrez avec SkillsProof</h2>
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="cardFeature">
                    ...
                    <h5 class="font-title--xs">250k Cours en Ligne</h5>
                    <p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="cardFeature">
                    ...
                    <h5 class="font-title--xs">Instructeurs Experts</h5>
                    <p>
...
<!--  Les Étapes d'Apprentissage Commencent Ici -->
            ...
            <div class="col-lg-6 order-2 order-lg-0">
                <div class="learning-rules-starts">
                    <h2 class="font-title--md">
                        Les Étapes d'Apprentissage <br class="d-none d-md-block" />
                        Simples avec SkillsProof
                    </h2>
                    <div class="learning-rules__wrapper">
                        <div class="learning-rules-item">
                            ...
                            <div class="item-text">
                                ...
                                <p>
                                    Démarrez en créant un compte pour accéder à vos cours, suivre vos progrès et organiser vos ressources.
                        ...
                        <div class="learning-rules-item">
                            ...
                            <div class="item-text">
                                <h6>Trouvez le Meilleur Cours avec un Filtrage Efficace.</h6>
                                <p>
                                    Utilisez nos outils de filtrage avancés pour découvrir les cours qui correspondent le mieux à vos besoins et objectifs.
                        ...
                        <div class="learning-rules-item">
                            ...
                            <div class="item-text">
                                ...
                                <p>
                                    Suivez vos cours, obtenez des certifications, et améliorez vos compétences pour réussir dans votre carrière ou vos passions.

                                </p>
                            </div>
                        </div>
                    </div>
                    <a href="#" class="button button-lg button--primary">Commencez à Apprendre</a>
                </div>
            </div>
    ...
    <div class="container about-services-area">
        <div class="row">
            <div class="col-lg-6 text-center mx-auto">
                <h2 class="font-title--md">Ce Que Nos Étudiants Disent de Nos Services</h2>
            </div>
        </div>
        ...
        <div class="testimonial testimonial--one testimonial__slider--one">
            <div class="testimonial__item">
                <p>
                    “Grâce à ces cours, j'ai pu acquérir des compétences en design UI/UX qui m'ont ouvert des portes professionnelles incroyables. Les professeurs sont passionnés et dévoués à la réussite de chaque étudiant."
                </p>
                <div class="testimonial__user-wrapper d-flex justify-content-between">
                    <div class="testimonial__user d-flex align-items-center">
                        ...
                        <div class="testimonial__user-info">
                            <h6>Sheikh Rashed</h6>
                            <span class="font-para--md">Étudiant UI/UX</span>
                        </div>
                    </div>
            ...
            <div class="testimonial__item">
                <p>
                    “Les outils et méthodes que j'ai appris ici m'ont permis de devenir un professionnel du design. L'équipe enseignante est toujours disponible pour répondre à nos questions, même en dehors des heures de cours."
                </p>
                <div class="testimonial__user-wrapper d-flex justify-content-between">
                    <div class="testimonial__user d-flex align-items-center">
                        <div class="testimonial__user-img">
                        ...
                        <div class="testimonial__user-info">
                            <h6>Dev Zakir</h6>
                            <span class="font-para--md">Étudiant en Design</span>
                        </div>
                    </div>
                    <ul class="testimonial__item-star d-flex align-items-center">
                        <li>
            ...
            <div class="testimonial__item">
                <p>
                    “J'ai non seulement appris des concepts théoriques, mais j'ai aussi travaillé sur des projets pratiques qui m'ont préparé à la vie professionnelle. Une expérience formidable que je recommande vivement."
                </p>
                <div class="testimonial__user-wrapper d-flex justify-content-between">
                    <div class="testimonial__user d-flex align-items-center">
                        <div class="testimonial__user-img">
                        ...
                        <div class="testimonial__user-info">
                            <h6>Mubarak Hossen</h6>
                            <span class="font-para--md">Étudiant en Informatique</span>
                        </div>
                    </div>
                    <ul class="testimonial__item-star d-flex align-items-center">
                        <li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 position-relative">
                <h3 class="text-center mb-40 font-title--md">Rencontrez nos meilleurs instructeurs</h3>
...
<section class="section section--bg-offwhite-three latest-events-featured main-events-featured">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="font-title--md">Derniers evenements</h3>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <a href="{{route('searchCourse')}}" class="button button-lg button--primary mt-lg-5 mt-5">Parcourir tous les evenements</a>
            </div>
        </div>
    </div>
...
<section class="section main-become-instructor">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="main-become-instructor-item me-12">
                    <div class="main-image">
                        <img src="{{asset('frontend/dist/images/event/image01.png')}}" alt="Devenir instructeur"
                            class="img-fluid" />
                    </div>
                    <div class="main-text">
                        <h6 class="font-title--sm">Devenez un Instructeur Inspirant</h6>
                        <p>
                            Partagez votre passion et vos connaissances avec la prochaine génération de professionnels. En tant qu'instructeur, vous aurez l'opportunité d'influencer et de guider les esprits curieux tout en développant vos propres compétences pédagogiques. Rejoignez notre équipe d'experts et faites la différence !
                        </p>
                        <div class="text-center">
                            <a href="become-instructor.html" class="green-btn">Postulez Maintenant</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="main-become-instructor-item ms-12 mb-0">
                    <div class="main-image">
                        <img src="{{asset('frontend/dist/images/event/image02.png')}}" alt="Utiliser SkillsProof pour Business"
                            class="img-fluid" />
                    </div>
                    <div class="main-text">
                        <h6 class="font-title--sm">Optimisez Votre Entreprise avec SkillsProof</h6>
                        <p>
                            Transformez la manière dont votre entreprise gère les compétences et les performances. Avec SkillsProof, vous accédez à des outils puissants pour évaluer, former et développer votre équipe de manière efficace. Découvrez comment notre plateforme peut propulser votre entreprise vers de nouveaux sommets.
                        </p>
                        <div class="text-center">
                            <a href="#" class="green-btn">Découvrez SkillsProof pour Entreprises</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="main-become-instructor-shape">
        <img src="{{asset('frontend/dist/images/shape/line03.png')}}" alt="Décoratif"
            class="img-fluid" />
    </div>
</section>
            ...
            <div class="col-lg-8 mx-auto">
                <div class="newsletter-area">
                    ...
                    <p class="mt-2 mb-lg-4 mb-3">
                        Restez informé des dernières nouveautés, astuces, et offres exclusives ! Recevez directement dans votre boîte mail des contenus inspirants pour booster vos connaissances et rester à la pointe des tendances.
                    </p>
                    <form>
