        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0">
                ...
                <li class="breadcrumb-item d-none d-lg-inline-block"><a href="#"
                        class="fs-6 text-secondary">Détail du Cours Instructeur</a></li>
                ...
                <div class="instructor-courses-instructor">
                    ...
                    <div class="instructor-course-info">
                        ...
                        <div class="instructor-course-info-students">
                            ...
                            <div class="text text-center">
                                <h6>29</h6>
                                <p>Etudiants en apprentissage</p>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <div class="contentCard contentCard--course">
                                        ...
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="#" class="font-title--card">France
                                                    Conferance internationalle</a>
                                            </h5>
                                            <div
                                                ...
                                                <a href="instructor-profile.html"
                                                    ...
                                                    <p class="font-para--md">Amar Serigne</p>
                                                </a>
                                                <div class="price">
                                                    <span>€12</span>
                                                    <del>€95</del>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="contentCard contentCard--course">
                                        ...
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="#" class="font-title--card">France Conferance internationalle</a>
                                            </h5>
                                            <div
                                                class="contentCard-info d-flex align-items-center justify-content-between">
                                                <a href="instructor-profile.html"
                                ...
                                <div class="col-lg-12">
                                    <div class="instructor-rating-area d-flex">
                                        <div class="rating-number">
                                            ...
                                            <p>Evaluation de l'instructeur</p>
                                        </div>
                                    ...
                                    <div class="students-feedback">
                                        <div class="students-feedback-heading">
                                            <h5>retour des etudiants <span>(57,685)</span></h5>
                                            <div class="right">
                                                <h6>Sort by:</h6>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                        <li><button class="dropdown-item" type="button">Notation</button>
                                                        </li>
                                                        <li><button class="dropdown-item" type="button">D'autres Notations</button></li>
                                                        <li><button class="dropdown-item" type="button">D'autres Notations</button></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="feedback-comment">
                                        <h6 class="font-title--card">Laisser une note</h6>
                                        <span>Rating</span>
                                        ...
                                        <form action="#">
                                            ...
                                            <button type="submit"
                                                class="button button-lg button--primary float-end">Apres Review</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
